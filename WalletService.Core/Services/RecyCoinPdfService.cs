...
public class RecyCoinPdfService : IRecyCoinPdfService
{
                ...
                doc.Page(page =>
                {
                    ...
                    page.Header().ShowOnce().Row(row =>
                    {
                        ...
                        row.RelativeItem().Column(col =>
                        {
                            col.Item().AlignRight()
                                .Background("#1E90FF") 
                                .Padding(10).Border(1).BorderColor("#FFFFFF") 
                                .AlignCenter()
                    ...
                    page.Content().PaddingVertical(10).Column(col1 =>
                    {
                        col1.Item().PaddingTop(10).Row(row =>
                        {
                            ...
                            {
                                col2.Item().AlignLeft().Text("Datos del cliente").Underline().Bold().FontColor("#FFFFFF");

                                col2.Item().Text(txt =>
                                {
                                    txt.Span("Nombre: ").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                    txt.Span($"{userInfo.Name} {userInfo.LastName}").FontColor("#FFFFFF").FontSize(10); 
                                });

                                col2.Item().Text(txt =>
                                {
                                    txt.Span("País: ").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                    txt.Span(userInfo.Country!.Name).FontColor("#FFFFFF").FontSize(10); 
                                });

                                col2.Item().Text(txt =>
                                {
                                    txt.Span("Ciudad: ").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                    txt.Span(userInfo.City).FontColor("#FFFFFF").FontSize(10); 
                                });
                            });
                            ...
                            row.RelativeItem().Column(col2 =>
                            {
                                ...
                                {
                                    txt.Span("Teléfono:").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                    txt.Span(userInfo.Phone).FontColor("#FFFFFF").FontSize(10); 
                                });

                                col2.Item().AlignRight().Text(txt =>
                                {
                                    txt.Span("No de Identificación fiscal:").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                    txt.Span(userInfo.UserName).FontColor("#FFFFFF").FontSize(10); 
                                });

                                col2.Item().AlignRight().Text(txt =>
                                {
                                    txt.Span("Correo:").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                    txt.Span(userInfo.Email).FontColor("#FFFFFF").FontSize(10); 
                                });

                                col2.Item().AlignRight().Text(txt =>
                                {
                                    txt.Span("Domicilio: ").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                    txt.Span(userInfo.Address).FontColor("#FFFFFF").FontSize(10); 
                                });
                                ...
                                col2.Item().AlignRight().Text(txt =>
                                {
                                    ...
                                    {
                                        txt.Span("Referencia:").SemiBold().FontSize(10).FontColor("#FFFFFF"); 
                                        txt.Span(spResponse.Reason).FontColor("#FFFFFF").FontSize(10); 
                                    }
                                });
                            });
                        });

                        col1.Item().LineHorizontal(0.5f).LineColor("#FFFFFF"); 
                        ...
                        col1.Item().Table(tabla =>
                        {
                            ...
                            tabla.Header(header =>
                            {
                                header.Cell().Background("#1E90FF").Padding(2).Text("Concepto")
                                    .FontColor("#39FF14"); 
                                header.Cell().Background("#1E90FF").Padding(2).Text("Cantidad")
                                    .FontColor("#39FF14"); 
                                header.Cell().Background("#1E90FF").Padding(2).Text("Precio")
                                    .FontColor("#39FF14"); 
                                header.Cell().Background("#1E90FF").Padding(2).Text("Descuento")
                                    .FontColor("#39FF14"); 
                                header.Cell().Background("#1E90FF").Padding(2).Text("Total")
                                    .FontColor("#39FF14"); 
                            });
                            ...
                            foreach (var item in invoice.invoices)
                            {
                                ...
                                tabla.Cell().BorderBottom(0.5f).BorderColor("#FFFFFF").Padding(2)
                                    .Text(conceptName).FontColor("#FFFFFF").FontSize(10); 
                                tabla.Cell().BorderBottom(0.5f).BorderColor("#FFFFFF").Padding(2)
                        ...
                        col1.Item().PaddingTop(10).Row(row =>
                        {
                            row.RelativeItem().Column(col2 =>
                            {
                                col2.Item().AlignRight().Text("Monto pagado").Bold().FontSize(16).FontColor("#FFFFFF"); 
                                col2.Item().AlignRight().Text($"Total: ${invoice.Debit.ToString("0.00")}")
                                    .FontSize(18).FontColor("#39FF14");
                                col2.Item().AlignRight().Text("Fecha de pago:").FontSize(12).FontColor("#FFFFFF"); 
                                col2.Item().AlignRight().Text(date).FontSize(12).FontColor("#FFFFFF"); 
                            });
                        });
                    ...
                    page.Footer()
                        ...
                        .Text(txt =>
                        {
                            txt.Span("Página ").FontSize(10).FontColor("#FFFFFF");
                            txt.CurrentPageNumber().FontSize(10).FontColor("#FFFFFF"); 
                            txt.Span(" de ").FontSize(10).FontColor("#FFFFFF"); 
                            txt.TotalPages().FontSize(10).FontColor("#FFFFFF"); 
                        });
                });
            });
                ...
                .Create(doc =>
                {
                    doc.Page(page =>
                    {
                        ...
                        page.Header().ShowOnce().Row(row =>
                        {
                            ...
                            row.RelativeItem().Column(col =>
                            {
                                col.Item().AlignRight().Background("#1F51FF").Border(1).BorderColor("#1F51FF")
                                    .AlignCenter()
                                    .Text($"Recibo #{invoice.Id}")
                                    .FontColor("#39FF14");

                                col.Item().AlignRight().Text("Razón Social: RecyCoin")
                                    .FontSize(10);
                                ...
                                col.Item().AlignRight().Text("Correo: support@recycoin.net").FontSize(10);
                        ...
                        page.Content().PaddingVertical(10).Column(col1 =>
                        {
                            ...
                            col1.Item().Table(tabla =>
                            {
                                ...
                                tabla.Header(header =>
                                {
                                    header.Cell().Background("#1F51FF").Padding(2).Text("Concepto")
                                        .FontColor("#39FF14");
                                    header.Cell().Background("#1F51FF").Padding(2).Text("Cantidad")
                                        .FontColor("#39FF14");
                                    header.Cell().Background("#1F51FF").Padding(2).Text("Precio").FontColor("#39FF14");
                                    header.Cell().Background("#1F51FF").Padding(2).Text("Descuento")
                                        .FontColor("#39FF14");
                                    header.Cell().Background("#1F51FF").Padding(2).Text("Total").FontColor("#39FF14");
                                });
