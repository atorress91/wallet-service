...
public class ToThirdPartiesPaymentStrategy : BaseService
{
    ...
    public async Task<bool> ExecutePayment(WalletRequest request)
    {
        ...
        var debitTransaction = new WalletTransactionRequest
        {
            ...
            Concept = Constants.PurchaseMadeToAffiliateByThirdParty + purchaseFor!.UserName,
            Support = null!,
            Date = today,
            Compression = false,
        ...
        var creditTransaction = new WalletTransactionRequest
        {
            ...
            UserId = Constants.AdminUserId,
            Credit = debit,
            Concept = Constants.PurchaseMadeByAffiliateForThirdParty + userInfoResponse!.UserName,
            Support = null!,
            Date = today,
            Compression = false,
