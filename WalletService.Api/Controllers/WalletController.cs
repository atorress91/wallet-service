...
public class WalletController : BaseController
{
    ...
    public async Task<IActionResult> PayWithMyBalanceForOthers([FromBody] WalletRequest request)
    {
        var response = await _walletService.PayWithMyBalanceForOthers(request);
